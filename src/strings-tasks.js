...
function sumOfCodes(str) {
  let sum = 0;
  if (str) {
    str.split('').forEach(function N(letter) {
...
function isPalindrome(str) {
  ...
  const str1 = str.toLowerCase().replace(reg, '');
...
function encodeToRot13(str) {
  return str.replace(/[a-z]/gi, (n) =>
    String.fromCharCode(n.charCodeAt(0) + (n.toLowerCase() <= 'm' ? 13 : -13))
  );
}
